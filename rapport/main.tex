...
\label{sec:5} 
In this section we will see two outcome examples with \py{state="chimera"} and \py{state="josephson"}. The graphs of the two other will be adding in the appendix of this document. The graphs, the gifs and their data could be find in the corresponding directory in the "outcomes" directory.
\subsection{Chimera}
\label{subs:chimera}
